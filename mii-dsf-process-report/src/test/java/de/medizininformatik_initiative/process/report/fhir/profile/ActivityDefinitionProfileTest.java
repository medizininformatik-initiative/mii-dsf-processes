...
public class ActivityDefinitionProfileTest
{
	...
	public void testAutostartValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/mii-report-autostart.xml"));
	...
	public void testSendValid() throws Exception
	{
		ActivityDefinition ad = validationRule
				.readActivityDefinition(Paths.get("src/main/resources/fhir/ActivityDefinition/mii-report-send.xml"));
	...
	{
		ActivityDefinition ad = validationRule
				.readActivityDefinition(Paths.get("src/main/resources/fhir/ActivityDefinition/mii-report-receive.xml"));
