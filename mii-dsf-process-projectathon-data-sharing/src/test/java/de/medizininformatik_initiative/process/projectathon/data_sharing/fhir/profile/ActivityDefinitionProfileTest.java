...
public class ActivityDefinitionProfileTest
{
	...
	public void testCoordinateDataSharingValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/mii-projectathon-coordinate-data-sharing.xml"));
	...
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/mii-projectathon-execute-data-sharing.xml"));
	...
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/mii-projectathon-merge-data-sharing.xml"));
