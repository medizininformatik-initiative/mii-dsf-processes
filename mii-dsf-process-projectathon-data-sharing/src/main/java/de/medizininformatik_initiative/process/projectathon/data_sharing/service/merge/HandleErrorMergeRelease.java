...
public class HandleErrorMergeRelease extends AbstractServiceDelegate implements InitializingBean
{
	private static final Logger logger = LoggerFactory.getLogger(HandleErrorMergeRelease.class);

	private final MailService mailService;

	public HandleErrorMergeRelease(FhirWebserviceClientProvider clientProvider, TaskHelper taskHelper,
	...
	protected void doExecute(DelegateExecution execution)
	{
		...
		String message = "The following error occurred whilst executing process '"
				...
				+ projectIdentifier
				+ "'. Please repair the error and answer the new user-task 'release-merged-data-set'.\n\n" + "Error:\n"
				+ error;
